...
Mesh* OBJFactory::Generate(std::string fileName) 
{
	...
	return new Mesh(vertexBuffer, textureCoordinateBuffer, normalBuffer, parameterCoordinateBuffer, vertexIndexBuffer, textureIndexBuffer, normalIndexBuffer, parameterIndexBuffer);
}